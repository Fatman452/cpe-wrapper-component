...
var CPE__default = /*#__PURE__*/_interopDefaultLegacy(CPE);
...
var CpeIntegration = function CpeIntegration(_ref) {
  ...
  var _useState3 = React.useState("pointer"),
  ...
  React.useEffect(function () {
    ...
    CPE.ServiceManager.registerService("document", documentService);
    CPE.ServiceManager.registerService("emailCustomerAccount", new EmailCustomerAccountService());
    CPE.ServiceManager.registerService("account", new AccountService());
    CPE.ServiceManager.registerService("commonData", new CommonDataService());
    CPE.ServiceManager.registerService("vimeo", new VimeoService());
    var cpeInstance = new CPE__default['default']({
      el: ".editor-document",
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    className: "Icon--disk"
  }), /*#__PURE__*/React__default['default'].createElement("span", null, "Save"))), /*#__PURE__*/React__default['default'].createElement("span", {
  ...
  }, "Continue")))))), /*#__PURE__*/React__default['default'].createElement("div", {
...
exports.CpeIntegration = CpeIntegration;
